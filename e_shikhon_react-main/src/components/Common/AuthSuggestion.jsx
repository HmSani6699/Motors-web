    ...
    <div className="flex-1 relative" ref={suggestionRef}>
      <div className="flex gap-3">
        <div className={`flex-1`}>
          {children}
          <div
            className={`w-full h-40 bg-gray-100 absolute top-12 left-0 rounded-md overflow-hidden shadow-lg overflow-y-scroll custom_scroll z-10 ${showSuggesstion ? "block" : "hidden"
              }`}
          >
            {loading ? (
